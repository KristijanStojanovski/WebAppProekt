...
<section class="featured-product section-padding" style="padding: 40px 0;">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="mb-5" style="font-size: 36px; font-weight: bold; color: #333;">Featured Products</h2>
            </div>
            ...
            <?php if (is_array($data['posts']) && count($data['posts']) > 0): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p style="text-align: center; font-size: 18px; color: #777;">No featured products available.</p>
            <?php endif; ?>
        </div>
    </div>
</section>
